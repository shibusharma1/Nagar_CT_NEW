...
$sql = "CREATE TABLE IF NOT EXISTS vehicle (
    ...
    seats INT NOT NULL CHECK (seats > 0),  -- Ensuring seats is a positive number
    ...
    bill_book_expiry_date DATE NOT NULL,  
    ...
    INDEX (vehicle_company_id),
    INDEX (vehicle_category_id)
) ENGINE=InnoDB;";
